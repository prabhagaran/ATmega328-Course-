 ...
 * Note: This program initializes Timer/Counter0 in counter mode with interrupt.
 It counts pulses using an external event and triggers an interrupt on timer overflow.
 Adjust the value of YOUR_TIME_THRESHOLD according to the desired time interval for event timing.
